  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3>One time SEO Configuration</h3>

        <p>
        <i class="fa fa-check fa-fw fa-lg" > </i> £1000 is for a reasonable size website, probably around 100 page website; Additional budget will be charged for additional pages you want us to configure<br /><br /> 
